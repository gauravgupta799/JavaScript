const drop = documnent.querySelector(".drop");
const input = drop.querySelector(".drop input");
const text = drop.querySelector(".text");
const progress = drop.querySelector(".progress");
